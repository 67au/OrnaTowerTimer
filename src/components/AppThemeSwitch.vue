...
import { ref } from 'vue'
import { currentTheme, setTheme } from '@/styles'
...
<template>
  <var-menu close-on-click-reference placement="bottom" offset-y="2vmin" v-model:show="show">
    ...
    <template #menu>
      <var-cell
        ripple
        :style="getActiveStyles('md2-light')"
        @click="() => handleCellClick('md2-light')"
      >
        MD2 Light
      </var-cell>
      <var-cell
      ...
      <var-cell
        ripple
        :style="getActiveStyles('md3-light')"
        @click="() => handleCellClick('md3-light')"
      >
        MD3 Light
      </var-cell>
      <var-cell
